...
FPS_API UClass* Z_Construct_UClass_UTP_WeaponComponent();
FPS_API UClass* Z_Construct_UClass_UTP_WeaponComponent_NoRegister();
...
{
	P_GET_OBJECT(AFPSCharacter,Z_Param_TargetCharacter);
	P_FINISH;
	P_NATIVE_BEGIN;
...
struct Z_Construct_UClass_UTP_WeaponComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon, "AttachWeapon" }, // 2024903824
...
template<> FPS_API UClass* StaticClass<UTP_WeaponComponent>()
{
	return UTP_WeaponComponent::StaticClass();
}
